...
set :local_shared_files, %w(config/environments/development.rb config/environments/staging.rb config/database.yml config/cartodb_config.yml config/http_auth_config.yml)
